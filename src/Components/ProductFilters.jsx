...
export default function ProductFilters({
	...
	// toggles the selected option and sets the other option to false
	// sortOption is the object of the selected sorting option
	const handleSort = (sortOption) => {
		let sortOptionsCopy = [...sortOptions];

		// find selected option, toggle it and set the other options to false
		for (let i = 0; i < sortOptionsCopy.length; i++) {
			if (sortOptionsCopy[i].name == sortOption.name) {
				sortOptionsCopy[i].current = !sortOptionsCopy[i].current;
			} else {
				sortOptionsCopy[i].current = false;
			}
		}
