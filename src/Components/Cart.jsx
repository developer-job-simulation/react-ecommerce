						...
						>
							<div className="pointer-events-auto w-screen max-w-md">
								<div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
									<div
										className={
											"flex flex-col h-[100%] overflow-y-auto py-6 px-4 sm:px-6 " +
									...
									>
										...
										{/* <div className=""> */}
										{cart.length == 0 ? (
											<div className="self-center mb-auto flex flex-col items-center justify-center">
												<ShoppingCartIcon className="w-12" aria-hidden="true" />
